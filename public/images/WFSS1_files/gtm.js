...
l instanceof sb&&(m="OpaqueValue");if(m!=h)throw Error("Error in "+a+". Argument "+f+" has type "+m+", which does not match required type "+(ye[h]||h)+".");}}};function ze(a){if(a instanceof hb)return a.toString();if(a instanceof k)return"["+a.toString()+"]";if(a instanceof cb)return a.toString()+"()";if(p(a))return'"'+a+'"';return""+a}
...
return null},lg=!1;if(L.querySelectorAll)try{var mg=L.querySelectorAll(":root");mg&&1==mg.length&&mg[0]==L.documentElement&&(lg=!0)}catch(a){}var ig=lg;var Qd={},R=null,Ag=Math.random();Qd.C="GTM-PJ8M5SK";Qd.$b="920";Qd.gi="";var Bg={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Cg="www.googletagmanager.com/gtm.js";
var Dg=Cg,Eg=null,Fg=null,Gg="//www.googletagmanager.com/a?id="+Qd.C+"&cv=42",Hg={},Ig={},Jg=function(){var a=R.sequence||1;R.sequence=a+1;return a};
...
b),!0),f.set("hitCallback",void 0,!0));e(f);l&&(f.set("hitPayload",g,!0),f.set("hitCallback",h,!0),f.set("_x_19",void 0,!0),e(f))})}}};var tk=function(){var a=R.consumeTestResult;if(a&&Fa(a))return!0;return!1},uk=function(){var a={};return function(b,c,d){if(!tk())return;var e=a[b]||{testName:b,status:c,logMessages:[],elapsedTime:0};a[b]=e;switch(c){case 4:e.logMessages.push(d);break;case 3:d&&(e.error=d);break;case 5:e.returnValue=d}if(2===c||3===c){e.status=c;var f=R.consumeTestResult;f&&f(e)}}};function vk(a,b,c,d){var e=pd[a],f=wk(a,b,c,d);if(!f)return null;var g=xd(e[Bd.$d],c,[]);if(g&&g.length){var h=g[0];f=vk(h.index,{J:f,I:1===h.ve?b.terminate:f,terminate:b.terminate},c,d)}return f}
...
v("gdpr_consent",wl());"1"===Ai(!1)._up&&v("gtm_up","1");v("gclid",zl(b,f));v("gclsrc",g);v("gtm",Vk(!c));var B=w+"/pagead/landing?"+u.join("&");Mf(B)}}var e=Ui(),f=e.gclid||"",g=e.gclsrc,h=e.dclid||"",l=!a&&(!f||g&&"aw.ds"!==g?!1:!0),n=Zf();if(l||n){var m=""+Th();n?hg(function(){d();fg(H.o)||bg(function(r){return d(!0,r.ne)},H.o)},[H.o]):d()}}function zl(a,b){var c=a&&!fg(H.o);return b&&c?"0":b}
var Jl=function(a){return!(void 0===a||null===a||0===(a+"").length)},Kl=function(a,b){var c;if(2===b.aa)return a("ord",Ka(1E11,1E13)),!0;if(3===b.aa)return a("ord","1"),a("num",Ka(1E11,1E13)),!0;if(4===b.aa)return Jl(b.sessionId)&&a("ord",b.sessionId),!0;if(5===b.aa)c="1";else if(6===b.aa)c=b.Ed;else return!1;Jl(c)&&a("qty",c);Jl(b.fc)&&a("cost",b.fc);Jl(b.transactionId)&&a("ord",b.transactionId);return!0},Ml=function(a,b,c){function d(x,B,C){m.hasOwnProperty(x)||(B=String(B),n.push(";"+x+"="+(C?
B:Ll(B))))}var e=a.jd,f=a.Hd,g=a.protocol;g+=f?"//"+e+".fls.doubleclick.net/activityi":"//ad.doubleclick.net/activity";var h=";",l=!fg(H.o)&&a.Hb;l&&(g="https://ade.googlesyndication.com/ddm/activity",h="/",f=!1);var n=[h,"src="+Ll(e),";type="+Ll(a.md),";cat="+Ll(a.kb)],m=a.Eg||{};Na(m,function(x,B){n.push(";"+Ll(x)+"="+Ll(B+""))});if(Kl(d,a)){Jl(a.Cc)&&d("u",a.Cc);Jl(a.Bc)&&d("tran",a.Bc);d("gtm",Vk());Zf()&&(d("gcs",gg()),c&&d("gcu","1"));(function(x,B){B&&
d(x,B)})("gdpr_consent",wl());"1"===Ai(!1)._up&&d("gtm_up","1");!1===a.dg&&d("npa","1");if(a.hd){var r=void 0===a.Hb?!0:!!a.Hb,t=hj("dc",a.Ua,r);t&&t.length&&d("gcldc",t.join("."));var q=hj("aw",a.Ua,r);q&&q.length&&d("gclaw",q.join("."));var u=ij(r);u&&d("gac",u);di({prefix:a.Ua,zb:a.Bg,domain:a.Ag,flags:a.ni});var v=$h[ai(a.Ua)];v&&d("auiddc",v)}Jl(a.Ad)&&d("prd",a.Ad,!0);Na(a.Ld,function(x,B){d(x,B)});n.push(b||"");if(Jl(a.sc)){var w=a.sc||"";l&&(w=Dh(w));
d("~oref",w)}var y=g+n.join("")+"?";f?Ef(y,a.J):Ff(y,a.J,a.I)}else M(a.I)},Ll=encodeURIComponent,Ol=function(a,b){Zf()?hg(function(){Ml(a,b);fg(H.o)||bg(function(){Ml(a,b,!0)},H.o)},[H.o]):Ml(a,b)};var im=function(){var a=!0;xl(7)&&xl(9)&&xl(10)||(a=!1);var b=!0;b&&!hm()&&(a=!1);return a},hm=function(){var a=!0;xl(3)&&xl(4)||(a=!1);return a};function Cm(){var a=R;return a.gcq=a.gcq||new Dm}
...
a.vtp_userId);var l=wl();(h.google_additional_params=h.google_additional_params||{}).gdpr_consent=l;f(h)||c()}else c()},e=function(){U(b,d,c)};Zf()?hg(function(){fg(H.o)?e():bg(e,H.o)},[H.o]):(dk(),e())})}();
...
Z.b.f=["google"],function(){(function(a){Z.__f=a;Z.__f.g="f";Z.__f.h=!0;Z.__f.priorityOverride=0})(function(a){var b=jp("gtm.referrer",1)||L.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?Ah(Ch(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):ip(String(b)):String(b)})}();Z.b.k=["google"],function(){(function(a){Z.__k=a;Z.__k.g="k";Z.__k.h=!0;Z.__k.priorityOverride=0})(function(a){return mp(a.vtp_name,jp("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
